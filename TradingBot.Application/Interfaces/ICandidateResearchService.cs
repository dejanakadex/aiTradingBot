...
namespace TradingBot.Application.Interfaces
{
    public interface ICandidateResearchService
    {
        ...
        Task<int> PersistBatchAsync(PatternDetectionBatch batch, string sourceEventId, Guid? replayRunId = null, CandidateEvaluationContext? evaluationContext = null, CancellationToken cancellationToken = default);
